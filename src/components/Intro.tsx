  ...
  return (
    <Container>
      ...
      <div className="intro-container">
        <Typography variant='h1' color='primary' className='intro-container__name'>Hi My name is <span className='intro-container__name-highlight'>Martin</span> Chong</Typography>
